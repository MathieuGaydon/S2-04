...
with open("Extension.txt","w") as file, open("jeu-de-données.csv","w", newline='' ,encoding='utf-8') as file2:
    file.write("--Insertion des données dans la base : " + "\n")
    writer = csv.writer(file2, delimiter=',')
    #-----------------------Organisme-----------------------------------------------
   
    file2.write("Organisme"+ "\n")
    ...
    file2.write("Utilisation Officielle"+ "\n")
